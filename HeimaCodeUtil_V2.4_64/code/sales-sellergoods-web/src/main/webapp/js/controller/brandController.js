...
var app=new Vue({
    ...
    methods:{
        ...
        searchList:function (currentPage) {
            axios.post('../brand/findPage?pageNo='+currentPage+"&pageSize="+this.pageSize,this.searchEntity).then(function (response) {
                //获取数据
        ...
        //根据ID查询
        findOne:function (id) {
            axios.get('../brand/findOne?id='+id).then(function (response) {
